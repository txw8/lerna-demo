  ...
  <div class="headerWrapper">
    ...
    :class="{
      ...
      <div class="container">
        ...
        <a href="http://element-cn.eleme.io" target="_blank" v-if="false">
          <img
...
<script>
  ...
  export default {
    ...
    computed: {
      lang() {
        return 'http://element-cn.eleme.io';// this.$route.path.split('/')[1] || 'zh-CN';
      },
      langConfig() {
    ...
    methods: {
      switchLang(targetLang) {
        ...
        localStorage.setItem('YUFPWP_LANGUAGE', targetLang);
