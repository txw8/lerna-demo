  ...
  export default {
    ...
    methods: {
      goJsfiddle() {
        ...
        '\n<scr' + `ipt src="//unpkg.com/yuwp-ui@${ version }/lib/index.js"></scr` + 'ipt>';
        let jsTpl = (script || '').replace(/export default/, 'var Main =').trim();
        let htmlTpl = `${resourcesTpl}\n<div id="app">\n${html.trim()}\n</div>`;
        let cssTpl = `@import url("//unpkg.com/yuwp-ui@${ version }/lib/theme-default/index.css");\n${(style || '').trim()}\n`;
        jsTpl = jsTpl
